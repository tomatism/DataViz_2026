...
\noindent To compute the proportion of congregations with above-average income for each year and 12-level religious classification, the data was further wrangled. For each combination, the mean of the \texttt{AVGINCOME} binary variable was calculated, yielding the share of congregations with a value of 1. The proportion reported is out of the congregations reporting their annual income level, thus removing those having NA values for the \texttt{INCOME} variable. The proportion of below average income levels congregations was computed as 1 - \%above average. 

\noindent The data was then pivoted so that for each year the proportion of above and below income level congregations would be in the same column, \texttt{IncomeLevel}. 


\vspace{0.5cm}
\lstinputlisting[language=R, firstline=96, lastline=104]{PS02_MT.R}
...
\vspace{0.5cm}
\lstinputlisting[language=R, firstline=111, lastline=130]{PS02_MT.R}
...
\vspace{0.5cm}
\lstinputlisting[language=R, firstline=138, lastline=145]{PS02_MT.R}
...
\lstinputlisting[language=R, firstline=151, lastline=167]{PS02_MT.R}
\vspace{0.5cm}
...
\lstinputlisting[language=R, firstline=173, lastline=212]{PS02_MT.R}
\vspace{0.5cm}
...
\vspace{0.5cm}
\lstinputlisting[language=R, firstline=224, lastline=241]{PS02_MT.R}
