...
First, you need to \href{https://personal.lse.ac.uk/hix/HixNouryRolandEPdata.HTM}{download data} from the first European Parliament, including information on each MEP from EP1 and how they voted in each recorded roll-call vote during EP1.
...
\begin{itemize}
	\item \texttt{mep\_info\_26Jul11.xls} (includes MEP characteristics from EP1–EP5, you need “Sheet = EP1”)
...
\begin{enumerate}
	...
	\item Produce a boxplot of the proportion voting \textit{Yes} for each vote by EP group to visualize cohesion.
	\item Display the proportion voting \textit{Yes} across votes by national party using a bar plot.
